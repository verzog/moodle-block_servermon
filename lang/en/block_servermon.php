...
$string['iso_systemcount'] = '…plus {$a} lower-level system account(s) (UID < 1000).';
...
$string['iso_users_intro'] = 'Accounts with UID ≥ 1000. On a properly isolated server each hosted site has its own dedicated user — often a shell-less service account (nologin).';
